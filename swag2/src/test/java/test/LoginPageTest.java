...
public class LoginPageTest extends baseTest {
    @Test
    public void testCheckoutAndLogoutFlow() throws InterruptedException {
    ...
    @Test
    public void testCheckoutAndLogoutFlowFalse() throws InterruptedException {
        LoginPage loginPage = new LoginPage(driver);
    ...
    @Test
    public void testCheckoutAndLogoutFlowTrue() throws InterruptedException {
        LoginPage loginPage = new LoginPage(driver);
